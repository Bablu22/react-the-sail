                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2">
                            ...
                            <form className="flex flex-col justify-center p-6">
                                ...
                                <div className="flex flex-col mt-2">
                                    ...
                                    <input type="name" name="name" id="name" placeholder="Full Name" className="px-3 py-3 mt-2 mb-6 font-semibold text-gray-800 bg-white border border-gray-400 rounded-lg w-100 focus:border-indigo-500 focus:outline-none" />
                                </div>
