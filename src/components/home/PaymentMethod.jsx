...
const PaymentMethod = () => {
    return (
        <div className="px-2 mx-auto mt-48 mb-20 lg:px-0 ">
            <div className="lg:space-x-20 lg:flex lg:justify-center">
                <h2 className="pb-5 text-3xl lg:px-0 font-primary">payment methods</h2>
